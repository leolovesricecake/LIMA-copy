...
def parse_args():
    ...
    parser.add_argument('--json-dir', 
                        type=str, 
                        default='explanation_insertion_results/imagenet-clip-vitl-true/KernelShap',
                        help='')
    parser.add_argument('--npy-dir', 
                        type=str, 
                        default='explanation_results/imagenet-clip-vitl-true/KernelShap',
                        help='')
    parser.add_argument('--save-dir', 
                        type=str, 
                        default="./baseline_visualization/imagenet-clip-vitl-true/KernelShap",
                        help='')
...
def main(args):
    json_root_file = args.json_dir
    npy_root_file = args.npy_dir
    image_path_root = args.image_dir
    ...
    for json_file in tqdm(json_files):
        ...
        image_path = os.path.join(image_path_root, json_file.replace(".json", ".JPEG"))
        
        visualization_save_path = os.path.join(args.save_dir, json_file.replace(".json", ".png"))
        ...
        if "23943" in json_file:
            cv2.imwrite("Kernel SHAP.jpg",im)
        else:
            continue
