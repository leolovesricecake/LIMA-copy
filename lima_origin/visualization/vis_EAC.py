...
def parse_args():
    ...
    parser.add_argument('--json-dir', 
                        type=str, 
                        default='explanation_results/EAC_CLIP_vitl_true/json',
                        help='')
    parser.add_argument('--npy-dir', 
                        type=str, 
                        default='explanation_results/EAC_CLIP_vitl_true/npy',
                        help='')
    parser.add_argument('--save-dir', 
                        type=str, 
                        default="./baseline_visualization/imagenet-clip-true/EAC",
                        help='')
