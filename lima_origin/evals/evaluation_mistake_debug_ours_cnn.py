...
explanation_method = "./submodular_results/cub-fair-mobilenetv2/SAM-1.0-1.0-10.0-1.0"
# explanation_method = "explanation_insertion_results/imagenet-fair-clip-vitl/Rise"
eval_list = "datasets/CUB/eval_fair-mobilenetv2.txt"
...
def main(percentage):
    ...
    # print("When percentage is {}, the avg. highest confidence is {}, std:{}".format(
    #     percentage, mean_highest_acc, std_highest_acc
    # ))
