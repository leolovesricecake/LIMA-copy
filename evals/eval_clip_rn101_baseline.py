...
def parse_args():
    ...
    parser.add_argument('--explanation-method', 
                        type=str, 
                        default='./explanation_results/imagenet-clip-rn101-true/Saliency',
...
def main(args):
    ...
    # original
    deletion_metric = Deletion(model, input_image, label_onehot, steps=50, batch_size=512)
    insertion_metric = Insertion(model, input_image, label_onehot, steps=50, batch_size=512)
