...
def _to_int(value: object, default: int) -> int:
    """Handle the to int step of adaptive text chunking."""
...
def _to_float(value: object, default: float) -> float:
    """Handle the to float step of adaptive text chunking."""
...
def _normalize_short_floor_mode(value: object) -> str:
    """Handle the normalize short floor mode step of adaptive text chunking."""
...
def _normalize_guard_mode(value: object) -> str:
    """Handle the normalize guard mode step of adaptive text chunking."""
...
def _apply_overrides_to_profile(
    *,
    ...
    """Handle the apply overrides to profile step of adaptive text chunking."""
...
def _resolve_profile(
    ...
    """Handle the resolve profile step of adaptive text chunking."""
...
def _count_words(text: str) -> int:
    """Handle the count words step of adaptive text chunking."""

    return len(_WORD_RE.findall(text))


def _count_punct(text: str) -> int:
    """Handle the count punct step of adaptive text chunking."""

    return len(_PUNCT_RE.findall(text))


def _count_sentence_end_est(text: str) -> int:
    """Handle the count sentence end est step of adaptive text chunking."""
...
def _has_short_structural_signal(*, punct_count: int, newline_count: int, sentence_end_count_est: int) -> bool:
    """Handle the has short structural signal step of adaptive text chunking."""
...
def _spans_from_regex_boundaries(text: str, pattern: re.Pattern[str]) -> List[Tuple[int, int]]:
    """Handle the spans from regex boundaries step of adaptive text chunking."""
...
def _cleanup_spans(text: str, spans: Sequence[Tuple[int, int]]) -> List[Tuple[int, int]]:
    """Handle the cleanup spans step of adaptive text chunking."""
...
def _spans_to_chunks(text: str, spans: Sequence[Tuple[int, int]]) -> List[TextChunk]:
    """Handle the spans to chunks step of adaptive text chunking."""
...
def _try_load_pysbd() -> Any | None:
    """Handle the try load pysbd step of adaptive text chunking."""
...
def _build_pysbd_segmenter(pysbd_module: Any, *, char_span: bool) -> Any | None:
    """Handle the build pysbd segmenter step of adaptive text chunking."""
...
def _validate_char_spans(text: str, span_rows: Sequence[Any]) -> List[Tuple[int, int]] | None:
    """Handle the validate char spans step of adaptive text chunking."""
...
def _spans_from_segments_by_cursor(text: str, segments: Sequence[str]) -> List[Tuple[int, int]]:
    """Handle the spans from segments by cursor step of adaptive text chunking."""
...
def _sentence_spans_with_backend(text: str) -> Tuple[List[Tuple[int, int]], str, bool]:
    """Handle the sentence spans with backend step of adaptive text chunking."""
...
def _paragraph_spans(text: str) -> List[Tuple[int, int]]:
    """Handle the paragraph spans step of adaptive text chunking."""

    return _spans_from_regex_boundaries(text, _PARAGRAPH_SPLIT_RE)


def _clause_spans(text: str) -> List[Tuple[int, int]]:
    """Handle the clause spans step of adaptive text chunking."""
...
def _word_window_spans(text: str, start: int, end: int, max_words: int) -> List[Tuple[int, int]]:
    """Handle the word window spans step of adaptive text chunking."""
...
def _split_overlong_span(
    ...
    """Handle the split overlong span step of adaptive text chunking."""
...
def _split_overlong_span_clause_first(
    ...
    """Handle the split overlong span clause first step of adaptive text chunking."""
...
def _merge_invalid_spans(text: str, spans: Sequence[Tuple[int, int]]) -> Tuple[List[Tuple[int, int]], int]:
    """Handle the merge invalid spans step of adaptive text chunking."""
...
def _merge_short_spans(
    ...
    *,
    ...
    """Handle the merge short spans step of adaptive text chunking."""
...
def _split_long_spans(
    ...
    *,
    ...
    """Handle the split long spans step of adaptive text chunking."""
...
def _split_point_from_words_or_chars(text: str, start: int, end: int) -> int | None:
    """Handle the split point from words or chars step of adaptive text chunking."""
...
def _pick_preferred_boundary(start: int, end: int, boundaries: Sequence[int]) -> int | None:
    """Handle the pick preferred boundary step of adaptive text chunking."""
...
def _collect_short_bucket_boundaries(text: str) -> List[int]:
    """Handle the collect short bucket boundaries step of adaptive text chunking."""
...
def _apply_effective_chunk_floor(
    ...
    *,
    ...
    """Handle the apply effective chunk floor step of adaptive text chunking."""
...
def _pack_adjacent_spans_by_word_budget(
    ...
    *,
    ...
    """Handle the pack adjacent spans by word budget step of adaptive text chunking."""
...
def _collect_sentence_boundaries(text: str) -> set[int]:
    """Handle the collect sentence boundaries step of adaptive text chunking."""
...
def _collect_strong_boundaries(text: str) -> set[int]:
    """Handle the collect strong boundaries step of adaptive text chunking."""
...
def _is_quote_paren_boundary(text: str, boundary: int) -> bool:
    """Handle the is quote paren boundary step of adaptive text chunking."""
...
def _pack_adjacent_spans_to_target_max(
    ...
    *,
    ...
    """Handle the pack adjacent spans to target max step of adaptive text chunking."""
...
def _compute_soft_band_targets(
    *,
    ...
    """Handle the compute soft band targets step of adaptive text chunking."""
...
def _apply_fragmentation_guard(
    ...
    *,
    ...
    """Handle the apply fragmentation guard step of adaptive text chunking."""
...
def _bucket_for_word_count(word_count: int, thresholds: Dict[str, int]) -> str:
    """Handle the bucket for word count step of adaptive text chunking."""
...
def _initial_spans_for_bucket(text: str, bucket: str) -> Tuple[List[Tuple[int, int]], Dict[str, object]]:
    """Handle the initial spans for bucket step of adaptive text chunking."""
...
def adaptive_chunk_with_stats(
    ...
    *,
    ...
    """Handle the adaptive chunk with stats step of adaptive text chunking."""
...
def adaptive_chunk(
    ...
    *,
    ...
    """Handle the adaptive chunk step of adaptive text chunking."""
