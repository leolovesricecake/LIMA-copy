...
save_dir="submodular_results/ablation-imagebind-division-number/"
lambda1=0.01
lambda2=0.05
lambda3=20
lambda4=5
...
do
    ...
    CUDA_VISIBLE_DEVICES=$device python -m submodular_attribution.efficientv2-smdl_explanation_imagenet_imagebind_superpixel \
    --Datasets $dataset \
    --eval-list $eval_list \
    --lambda1 $lambda1 \
    --lambda2 $lambda2 \
