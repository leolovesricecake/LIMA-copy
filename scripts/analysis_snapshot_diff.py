...
def build_diff(baseline: Dict[str, Any], current: Dict[str, Any]) -> Dict[str, Any]:
    ...
    metrics = [
        ...
        "explain.timing_breakdown_totals.chunk_build_seconds",
        "explain.timing_breakdown_totals.search_seconds",
        "explain.timing_breakdown_totals.model_prefetch_seconds",
        "explain.objective_cache_stats.subset_cache_hit_rate",
        "explain.objective_cache_stats.prob_cache_hit_rate",
        "explain.objective_cache_stats.embed_cache_hit_rate",
        "explain.objective_cache_stats.evaluate_gains_calls",
