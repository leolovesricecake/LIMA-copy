...
explanation_method = "explanation_results/imagenet-vitl-true/Saliency"
image_root_path = "datasets/imagenet/ILSVRC2012_img_val"
eval_list = "datasets/imagenet/val_vitl_5k_true.txt"
save_doc = "imagenet-true-vitl"
steps = 50
batch_size = 10
image_size_ = 224
...
def main():
    ...
    model.load_state_dict(torch.load('ckpt/pytorch_model/vit_large_patch16_224_pretrained.pth'))  # 加载本地权重
    model.eval()
    model.to(device)
    ...
    for info in tqdm(infos[:]):
        ...
        if "ILSVRC2012_val_00039794" not in info:
            continue
